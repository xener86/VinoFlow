...
import { Download, Upload, Server, User, Bell, Key, Cpu, Check } from 'lucide-react';

export const Settings: React.FC = () => {
  const [importStatus, setImportStatus] = useState<string>('');
  const [config, setConfig] = useState<AIConfig>({ provider: 'GEMINI', keys: { gemini: '', openai: '', mistral: '' } });
