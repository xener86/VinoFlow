...
import { 
  Wine, PlusCircle, Sparkles, Settings as SettingsIcon, 
  BarChart3, Map, GlassWater, LogOut, Sun, Moon, Monitor 
} from 'lucide-react';
      ...
      <header className="h-16 border-b border-stone-200 dark:border-stone-800 flex items-center justify-between px-6 bg-white/80 dark:bg-stone-900/50 backdrop-blur-md z-10">
        <Link to="/" className="flex items-center gap-2 group">
          ...
          <h1 className="text-xl font-serif tracking-wide text-stone-800 dark:text-stone-100">
            <span className="font-bold">Vino</span>
            <span className="italic font-normal text-wine-700 dark:text-wine-500">Flow</span>
          </h1>
        </Link>
        ...
        <div className="flex gap-2 items-center">
          ...
          <button 
            ...
            className="p-2 rounded-full text-stone-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 ml-1 transition-colors" 
            title="Déconnexion"
          >
            <LogOut size={18} />
          </button>
